                ...
                ScrollView{
                    LazyVStack{
                        ...
                        ForEach(model.modules){module in
                            VStack(spacing: 20){
                                HomeViewRow(image: module.content.image, title: "Learn \(module.category)", description:  module.content.description, content:  "\(module.content.lessons.count) Lessons", time: module.content.time)
